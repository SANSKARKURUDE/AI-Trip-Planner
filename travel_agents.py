...
# Agents with improved instructions for tool usage

location_expert = Agent(
    role="City Navigation and Travel Logistics Specialist",
    goal="Provides essential travel logistics like accommodation, transport, and connectivity.",
...
local_guide = Agent(
    ...
    goal="Provides personalized recommendations for activities and attractions in the city based on the user's interests.",
    ...
    llm=llm,
    verbose=True,
    max_iter=10,  # Increased iterations
    allow_delegation=False
)

planning_expert = Agent(
    role="Travel Planning Expert",
    goal="Compiles all gathered information to build clear, practical, and well-organized travel plans.",
